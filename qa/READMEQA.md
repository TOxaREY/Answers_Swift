...
Когда-то в прошлом Обсервер создавался в произвольной очереди (не обязательно в главной очереди).
Обсервер все еще существует.
...
[ОТВЕТ](https://github.com/TOxaREY/Answers_Swift/blob/master/qa/QA_27.md)

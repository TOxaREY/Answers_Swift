...
/*
 ...
 По хорошему чтобы всё работало правильно нужно применить addObserver(forName:object:queue:using:)
 Здесь можно указать очередь и тутда же посылать пост, но это уже operation queue.
 Может здесь про него и спрашивают.
 */
